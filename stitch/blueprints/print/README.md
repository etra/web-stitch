...
|--------|------|---------|-------------|
| GET | `/print/<project_id>` | `view` | View pattern with colored and symbol charts |

## Route Details

### `GET /print/<project_id>`
...
**Outputs:** HTML (`print/view.html`) with:
...
Located in `stitch/blueprints/print/static/print/`:

| File | Purpose |
|------|---------|
| `print.css` | Pattern view styles and print media queries |
